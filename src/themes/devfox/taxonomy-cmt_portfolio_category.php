...
get_header(); ?>
	...
	<section id="primary" class="content-area <?php echo cymolthemes_sanitize_html_classes(cymolthemes_sidebar_class('content-area')); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			$view   = ( !empty($devfox_theme_options['pfcat_view']) ) ? $devfox_theme_options['pfcat_view'] : 'overlay' ;
			$column = ( !empty($devfox_theme_options['pfcat_column']) ) ? $devfox_theme_options['pfcat_column'] : 'three' ;
