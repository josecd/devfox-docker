...
class CSFramework_Option_cymolthemes_wpml extends CSFramework_Options {
  ...
  public function output(){
	...
	$config['box_title']		= esc_attr__( 'Multilingual Devfox Theme', 'devfox' );
	$config['name']				= esc_attr( 'Devfox' ); //name of theme/plugin
	$config['box_description']	= esc_attr__('Devfox theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.', 'devfox' );
