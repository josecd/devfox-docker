...
class CSFramework_Option_cymolthemes_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title   = ( isset( $button_title ) ) ? $button_title : esc_attr__( 'Upload', 'devfox' );
    $frame_title    = ( isset( $frame_title  ) ) ? $frame_title  : esc_attr__( 'Upload', 'devfox' );
    $insert_title   = ( isset( $insert_title ) ) ? $insert_title : esc_attr__( 'Use Image', 'devfox' );
	...
	$btntext_add    = esc_attr__('Add image','devfox');
	$btntext_change = esc_attr__('Change image','devfox');
	$btntext        = ( empty( $value ) )  ? esc_attr__('Add image','devfox') : esc_attr__('Change image','devfox');
	...
	echo '<div class="cs-image-preview"><div class="cs-preview"><div class="cs-preview-inner">
			...
			<img src="'. esc_attr($preview) .'" alt="' . esc_attr__('preview','devfox') . '" class="'. esc_attr($hidden) .'" />
			<div class="cmt-sboxcs-background-heading-noimg'. esc_attr($hidden_text) .'"> ' . esc_attr__('No image selected for background','devfox') . ' </div>
		</div></div></div>';
	...
	echo '<small>'. esc_attr__('BG image repeat','devfox') .'</small>';
	...
	echo '<small>'. esc_attr__('BG image position','devfox') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	echo '<small>'. esc_attr__('BG image attachment','devfox') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	echo '<small>'. esc_attr__('BG image size','devfox') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	if( isset($this->field['color']) && $this->field['color']==false ){
		...
		echo '<small>'. esc_attr__('BG image color','devfox') .'</small>';
		echo cs_add_element( array(
			'pseudo'          => true,
