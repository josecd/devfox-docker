...
class CSFramework_Option_cymolthemes_iconpicker extends CSFramework_Options {
  ...
  public function output(){
	...
	$icon_library_array = array( // all icon library list array
		'themify'        => array( esc_attr__( 'Themify icons', 'devfox' ), 'ti-location-pin'),
		'linecons'       => array( esc_attr__( 'Linecons', 'devfox' ), 'li_star'),
		'cmt_devfox'     => array( esc_attr__( 'Devfox Icons', 'devfox' ), 'flaticon-fruits'),
	);
	...
	$icon_picker_html    = '';
	$icon_dropdown_array = array( esc_attr__( 'Font Awesome', 'devfox' )    => 'fontawesome' );
