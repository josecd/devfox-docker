<?php
/**
 * Devfox functions and definitions
 *
...
function cymolthemes_setup() {
	 ...
	 * If you're building a theme based on devfox, use a find and replace
	 * to change 'devfox' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'devfox', get_template_directory() . '/languages' );
	...
	register_nav_menus( array( // https://codex.wordpress.org/Function_Reference/has_nav_menu
		'cymolthemes-main-menu'			=> esc_html__( 'Main Menu', 'devfox' ),
	) );	
	
	if( function_exists('cymolthemes_devfox_cs_framework_init')){
		register_nav_menus( array( // https://codex.wordpress.org/Function_Reference/has_nav_menu
		'cymolthemes-footer-menu'		=> esc_html__( 'Footer Menu', 'devfox' ),
		) );
	}
