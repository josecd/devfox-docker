	...
	<?php
		...
		<div class="cymolthemes-blogbox-sharebox">	
				...
				<?php
					...
					if( !empty($tags_list) ) : ?>	
						<div class="cmt_tag_lists"><?php echo esc_attr__( 'Tags', 'devfox' ); ?>: <span class="cymolthemes-tags-links"><?php echo cymolthemes_wp_kses($tags_list); ?></span></div>
					<?php endif; ?>	
