<article class="cymolthemes-box cymolthemes-box-blog cymolthemes-blogbox-stylethree cymolthemes-blogbox-format-<?php echo get_post_format() ?> <?php echo cymolthemes_sanitize_html_classes(cymolthemes_post_class()); ?>">
	<div class="post-item">
