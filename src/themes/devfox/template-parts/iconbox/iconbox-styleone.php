...
<div class="cymolthemes-iconbox cymolthemes-iconbox-<?php echo esc_attr($boxstyle); ?><?php echo esc_attr($mainclass); ?> cymolthemes-iconcolor-<?php echo esc_attr($icon_color_html); ?> cymolthemes-iconsize-<?php echo esc_attr($icon_size_html); ?>">
