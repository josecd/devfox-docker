...
get_header(); ?>
	...
	<section id="primary" class="content-area <?php echo cymolthemes_sanitize_html_classes(cymolthemes_sidebar_class('content-area')); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			$view   = ( !empty($devfox_theme_options['teamcat_view']) ) ? $devfox_theme_options['teamcat_view'] : 'top-image' ;
			$column = ( !empty($devfox_theme_options['teamcat_column']) ) ? $devfox_theme_options['teamcat_column'] : 'three' ;
