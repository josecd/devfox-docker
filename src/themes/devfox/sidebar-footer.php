...
$right_content=$devfox_theme_options['footer_copyright_left'];
...
?>
				<div class="col-xs-12 <?php echo esc_attr($left_col_class); ?> <?php if(!empty($right_content)) { ?>cmt-footer2-left <?php } ?>">
					<?php
					if( !empty($devfox_theme_options['footer_copyright_left']) ){
					echo do_shortcode( $devfox_theme_options['footer_copyright_left'] );
					}
					?>
				</div><!--.footer menu -->
