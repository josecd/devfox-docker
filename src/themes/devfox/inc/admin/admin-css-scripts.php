 ...
 * @return void
 */
if( !function_exists('devfox_wp_admin_scripts_styles') ){
function devfox_wp_admin_scripts_styles() {
...
add_action( 'admin_enqueue_scripts', 'devfox_wp_admin_scripts_styles' );