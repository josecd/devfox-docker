...
class Devfox_Servicebox_Widget extends Widget_Base{

	public function get_name() {
		return 'cmt_service_element';
	}

	public function get_title() {
		return esc_attr__( 'Service Box', 'devfox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Service Style', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Our Services', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_attr__( 'Sort retrieved service by parameter.', 'devfox' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'DESC',
				'options' => [
		...
		if ( $posts->have_posts() ) {
			...
			<div class="cymolthemes-box-heading-wrapper <?php echo cymolthemes_wp_kses($headingclass); ?>">
				...
				if( function_exists('cymolthemes_get_filterbutton') ){
					$sortable_category_html = cymolthemes_get_filterbutton( $settings, 'cmt_service_category' );
			...
			while ( $posts->have_posts() ) {
				...
				if( file_exists( locate_template( '/template-parts/servicesbox/servicebox-'.esc_attr($style).'.php', false, false ) ) ){
	...
	protected function select_category() {
	  	$category = get_terms( array( 'taxonomy' => 'cmt_service_category', 'hide_empty' => false ) );
	  	$cat = array();
...
// Register widget
Plugin::instance()->widgets_manager->register_widget_type( new Devfox_Servicebox_Widget() );