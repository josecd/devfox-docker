...
class Devfox_Blogbox_Widget extends Widget_Base{

	public function get_name() {
		return 'cmt_blog_element';
	}

	public function get_title() {
		return esc_attr__( 'Blog Box', 'devfox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Blogbox Style', 'devfox' ),
				'description'	=> esc_attr__( 'Select Blogbox style.', 'devfox' ),
				'type' => Controls_Manager::SELECT,
				'label_block'	=> true,
				'options' => [
					'styleone'	=> esc_attr( 'BlogBox Style 1' ),
					'styletwo'	=> esc_attr( 'BlogBox Style 2' ),
					'stylethree'	=> esc_attr( 'BlogBox Style 3' ),
					'stylefour'	=> esc_attr( 'BlogBox Style 4' ),
					'stylefive'	=> esc_attr( 'BlogBox Style 5' ),
					'stylesix'	=> esc_attr( 'BlogBox Style 6' ),
					'styleseven'	=> esc_attr( 'BlogBox Style 7' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Blog', 'devfox' ),
		...
		if ( $posts->have_posts() ) {
			...
			<div class="cymolthemes-box-heading-wrapper <?php echo cymolthemes_wp_kses($headingclass); ?>">
				...
				if( function_exists('cymolthemes_get_filterbutton') ){
					$sortable_category_html = cymolthemes_get_filterbutton( $settings, 'category' );
...
// Register widget
Plugin::instance()->widgets_manager->register_widget_type( new Devfox_Blogbox_Widget() );