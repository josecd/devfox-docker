...
class Devfox_Clientbox_Widget extends Widget_Base{

	public function get_name() {
		return 'cmt_client_element';
	}

	public function get_title() {
		return esc_attr__( 'Client Logo Box', 'devfox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Client View Style', 'devfox' ),
				'description'	=> esc_attr__( 'Select Client View style.', 'devfox' ),
		...
		$this->start_controls_section(
			'data_section',
			[
				'label' => esc_attr__( 'Data Design', 'devfox' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_attr__( 'How many Post you want to show.', 'devfox' ),
				'separator' => 'before',
...
$this->start_controls_section(
		...
		if ( $posts->have_posts() ) {
			...
			<div class="cymolthemes-box-heading-wrapper <?php echo cymolthemes_wp_kses($headingclass); ?>">
				...
				if( function_exists('sortable_category') ){
					$sortable_category_html = sortable_category( $settings, 'cmt_client_group' );
	...
	protected function select_category() {
	  	$category = get_terms( array( 'taxonomy' => 'cmt_client_group', 'hide_empty' => false ) );
	  	$cat = array();
...
// Register widget
Plugin::instance()->widgets_manager->register_widget_type( new Devfox_Clientbox_Widget() );