...
class Devfox_Testimonialbox_Widget extends Widget_Base{

	public function get_name() {
		return 'cmt_testimonial_element';
	}

	public function get_title() {
		return esc_attr__( 'Testimonial Box', 'devfox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'			=> esc_attr__( 'Select Testimonial Style', 'devfox' ),
				'description'	=> esc_attr__( 'Select View style.', 'devfox' ),
				'type' => Controls_Manager::SELECT,
				'label_block'	=> true,
				'options' => [
					'styleone'	 => esc_attr( 'TestimonialBox Style 1' ),
					'styletwo'	 => esc_attr( 'TestimonialBox Style 2' ),
					'stylethree' => esc_attr( 'TestimonialBox Style 3' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_attr__( 'Testimonials', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_attr__( 'Show sub-heding before heading', 'devfox' ),
		...
		$this->add_responsive_control(
			'text_align',
			[
				'label' => esc_attr__( 'Alignment', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'options'		=> [
					...
					'slickview'		=> esc_attr__( 'Slick Style One Column Carousel', 'devfox' ),
				]
			]
		);
		...
		$this->add_control(
			'carousel_options',
			[
				'label' => esc_attr__( 'Carousel Options', 'devfox' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
		...
		$this->add_control(
			'cmt-loop',
			[
				'label'			=> esc_attr__( 'Carousel: Loop', 'devfox' ),
				'description'	=> esc_attr__( 'Infinity loop. Duplicate last and first items to get loop illusion.', 'devfox' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Autoplay of carousel.', 'devfox' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'devfox' ),
		...
		$this->add_control(
			'cmt-centermode',
			[
				'label'			=> esc_attr__( 'Carousel: Center', 'devfox' ),
				'description'	=> esc_attr__( 'Center item. Works well with even an odd number of items.', 'devfox' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Show arrow navigation.', 'devfox' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Show dots navigation.', 'devfox' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '0',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'autoplay speed.', 'devfox' ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Select how many column to show.', 'devfox' ),
				'type' => Controls_Manager::SELECT,
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> 'one',
...
$this->start_controls_section(
		...
		if ( $posts->have_posts() ) {
			...
			<div class="cymolthemes-box-heading-wrapper <?php echo cymolthemes_wp_kses($headingclass); ?>">
				...
				if( function_exists('cymolthemes_get_filterbutton') ){
					$sortable_category_html = cymolthemes_get_filterbutton( $settings, 'cmt_testimonial_group' );
					echo  cymolthemes_wp_kses($sortable_category_html);
				}
				?>
			</div>
			...
			if( !empty($slick_type) && $slick_type == 'slickview' ){
				...
				$footer             = '';
						...
						echo cymolthemes_wp_kses($startwrapper.
						$infowrapper.
							$content.
						$infowrapperend.
						$footerwrapper.
	...
	protected function select_category() {
	  	$category = get_terms( array( 'taxonomy' => 'cmt_testimonial_group', 'hide_empty' => false ) );
	  	$cat = array();
...
// Register widget
Plugin::instance()->widgets_manager->register_widget_type( new Devfox_Testimonialbox_Widget() );